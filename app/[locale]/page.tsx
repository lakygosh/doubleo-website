  ...
  return (
    <main id="main">
      ...
      <section className="solutions" id="solutions">
        ...
        {/* 01 — AI Receptionist */}
        <Reveal as="article" className="sol" id="sol-receptionist">
          ...
          <div className="sol__vig">
            <div className="vig vig--call">
              ...
              <p className="vig__bubble vig__bubble--them">{t("s1.v.caller")}</p>
              <p className="vig__bubble vig__bubble--us">{t("s1.v.agent")}</p>
              <p className="vig__result">{t("s1.v.result")}</p>
            </div>
          </div>
        </Reveal>

        {/* 02 — Lead Reactivation */}
        <Reveal as="article" className="sol sol--flip" id="sol-reactivation">
          <div className="sol__meta">
          ...
          <div className="sol__vig">
            <div className="vig vig--list">
              ...
              <p className="vig__row">
                <span>{t("s2.v.r1n")}</span>
                <span className="vig__chip vig__chip--ok">{t("s2.v.r1s")}</span>
              </p>
              <p className="vig__row">
                <span>{t("s2.v.r2n")}</span>
                <span className="vig__chip">{t("s2.v.r2s")}</span>
              </p>
              <p className="vig__row">
                <span>{t("s2.v.r3n")}</span>
                <span className="vig__chip">{t("s2.v.r3s")}</span>
              </p>
            </div>
          </div>
        </Reveal>
        ...
        {/* 03 — Speed to Lead */}
        <Reveal as="article" className="sol" id="sol-speed">
          <div className="sol__meta">
          ...
          <div className="sol__vig">
            <div className="vig vig--timeline">
              ...
              <p className="vig__foot">{t("s3.v.note")}</p>
            </div>
          </div>
        </Reveal>
